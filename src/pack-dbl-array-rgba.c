...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
// Convert a planar array of colours to packed RGBA format
//
...
//        column-major format
// @param w,h widht and height of image data
...
//        scaling.
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
void dbl_array_rgba_to_packed_argb32_inner(double *src, unsigned char *dst, int w, int h, double maxval) {
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
SEXP dbl_array_rgba_to_packed_argb32_(SEXP src_, SEXP maxval_) {
  ...
  //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  if (!isArray(src_)) {
    error("dbl_array_rgba_to_packed_argb32_(): src_ must be an array");
  }
  ...
  if (depth != 4) {
    error("dbl_array_rgba_to_packed_argb32_(): Array must have 4 planes");
  }
  ...
  dbl_array_rgba_to_packed_argb32_inner(src, dst, w, h, maxval);
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
// Convert packed ARGB32 format into a planar array with RGBA colour
//
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
void packed_argb32_to_dbl_array_rgba_inner(unsigned char *src, double *dst, int w, int h) {
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
SEXP packed_argb32_to_dbl_array_rgba_(SEXP src_) {

  unsigned char *src;

  src = isNull(src_) ? NULL : (unsigned char *)R_ExternalPtrAddr(src_);
  if (src == NULL) error("packed_argb32_to_dbl_array_rgba_: 'unsigned char * src' pointer is invalid/NULL");
  ...
  packed_argb32_to_dbl_array_rgba_inner(src, dst, w, h);
